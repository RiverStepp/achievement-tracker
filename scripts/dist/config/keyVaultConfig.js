...
exports.loadConfigFromKeyVault = loadConfigFromKeyVault;
const keyVault_1 = require("../utils/keyVault");
/**
...
async function loadConfigFromKeyVault() {
    ...
    (0, keyVault_1.initializeKeyVault)(keyVaultUri);
    // Load secrets from Key Vault
    // Note: Secret names use double dashes (--) as separators in Key Vault (matching .NET configuration format)
    const steamApiKey = await (0, keyVault_1.getSecret)('Authentication--Steam--ApiKey');
    const dbConnectionString = await (0, keyVault_1.getSecret)('ConnectionStrings--DefaultConnection');
