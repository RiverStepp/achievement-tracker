...
builder.Services.AddScoped<IAchievementSearchRepository, AchievementSearchRepository>();
builder.Services.AddScoped<IAchievementSearchService, AchievementSearchService>();
